...
// WithUserID adds the userID to the users get params
func (o *UsersGetParams) WithUserID(userID string) *UsersGetParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the users get params
func (o *UsersGetParams) SetUserID(userID string) {
	o.UserID = userID
}
