...
// removeCmd represents the users remove command
var removeCmd = &cobra.Command{
	Use:   "remove",
	Short: "Delete an user",
	Long: `Delete an user from an application`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// remove the user
		p := operations.NewUsersRemoveParams()
		p.UserID = id
		_, err = c.Operations.UsersRemove(p)
		if err != nil {
			return err
		}
...
func init() {
	...
	removeCmd.Flags().StringP("id", "", "", "unique ID of the user")
